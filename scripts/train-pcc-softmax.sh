#!/bin/zsh
#SBATCH --job-name=softmax-train-pcc
#SBATCH --time=1-72:00:00
#SBATCH --mincpus=5
#SBATCH --output pcc-softmax.log
#SBATCH -G 1 -c 5
...
python3 PointDA/trainer.py --dataroot /scratch/shapenets/pointda --batch_size 16 --softmax True
echo "Done Training"
