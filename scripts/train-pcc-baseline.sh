#!/bin/zsh
#SBATCH --job-name=baseline-train-pcc
#SBATCH --time=1-72:00:00
#SBATCH --mincpus=5
#SBATCH --output baseline_pcc.log
#SBATCH -G 1 -c 10
...
python3 PointDA/trainer.py --dataroot /scratch/shapenets/pointda --batch_size 16 --use_DeepJDOT False
echo "Done Training"
